    ...
    <section className="relative py-32 px-6 overflow-hidden z-10 max-w-7xl mx-auto">
      ...
      <div className="relative">
        ...
        <div className="grid lg:grid-cols-3 gap-12 lg:gap-8">
          ...
          <div className="relative group">
            <div className="relative bg-linear-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 cursor-pointer hover:-translate-y-1">
              {/* Step Number */}
      ...
      <div className="text-center mt-16">
        <SignUpButton mode="modal">
          <Button size={"lg"}>
            <ArrowRightIcon className="mr-2 size-5" /> Get Started Now
          </Button>
        </SignUpButton>
      </div>
    </section>
